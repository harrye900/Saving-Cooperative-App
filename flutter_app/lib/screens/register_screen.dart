...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    try {
      await context.read<AuthService>().register(_name.text.trim(), _phone.text.trim(), _password.text);
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Create Account', textAlign: TextAlign.center, style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              Text('Join AjoSave and start saving', textAlign: TextAlign.center, style: TextStyle(color: Colors.grey[600])),
              ...
              const SizedBox(height: 16),
              TextButton(onPressed: () => Navigator.pushReplacementNamed(context, '/login'), child: const Text('Already have an account? Login')),
            ],
          ),
        ),
      ),
